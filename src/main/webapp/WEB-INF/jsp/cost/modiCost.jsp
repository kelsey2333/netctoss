...
<html>
    ...
    <body>
        ...
        <!--主要区域开始-->
        <div id="main">            
            <form action="${base}/cost/midiCost.do" method="" class="main_form" )>
                <div class="text_info clearfix"><span>资费ID：</span></div>
                <div class="input_info"><input type="text" class="readonly" name="id" readonly value="${param.id}" /></div>
                <div class="text_info clearfix"><span>资费名称：</span></div>
                <div class="input_info">
                    <input type="text" class="width300" name="name" value="" placeholder="50长度的字母、数字、汉字和下划线的组合"/>
                ...
                <div class="input_info fee_type">
                    <c:choose>
                        <c:when test="${cost.costtype == '1'}">
                            <input type="radio" name="costtype" value="1"  checked="checked" id="monthly" onclick="feeTypeChange(1);" />
                        ...
                        <c:when test="${cost.costtype == '3'}">
                            ...
                            <input type="radio" name="costtype" value="2" id="package" onclick="feeTypeChange(2);" />
                            <label for="package">套餐</label>
                            <input type="radio" name="costtype" value="3"  checked="checked" id="timeBased" onclick="feeTypeChange(3);" />
                            <label for="timeBased">计时</label>
                        </c:when>
                    </c:choose>
                </div>
                ...
                <div class="input_info">
                    <input type="text" name="baseDuration" placeholder="1-600之间的整数" value="" class="width100" />
                    <span class="info">小时</span>
                    <span class="required">*</span>
                </div>
                <div class="text_info clearfix"><span>基本费用：</span></div>
                <div class="input_info">
                    <input type="text" placeholder="0-99999.99之间的数值" name="baseCost" value="" class="width100" />
                ...
                <div class="input_info">
                    <input type="text" placeholder="0-99999.99之间的数值" name="unitCost" value="" class="width100" />
                ...
                <div class="input_info_high">
                    <textarea class="width300 height70" name="descr" placeholder="100长度的字母、数字、汉字和下划线的组合">
                    </textarea>
